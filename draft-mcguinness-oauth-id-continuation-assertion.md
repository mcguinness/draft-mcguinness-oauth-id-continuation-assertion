...
one, the IdP issues an ordinary ID-JAG without a handle. Every onward target,
including a terminal RAS, needs the base profile's DPoP-bound JWT grant support
