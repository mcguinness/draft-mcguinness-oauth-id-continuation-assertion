...
expired chains. It MUST be able to revoke an entire chain and MAY revoke an
individual hop's subtree, and MUST reject continuation from revoked state.
...
audience, subject to audit requirements.
